...
/*
const char* ssid = "Puttipong iP_8";
const char* password = "Trolley555";
*/
// Change ssid & password according to hotspot you chose
const char* ssid = "Putt-iPad";
const char* password = "putty785";
...
byte rowPins[ROWS] = {13, 15, 3, 1};   // GIOP16, GIOP4, GIOP0, GIOP2 connect to the column pins
byte colPins[COLS] = {0, 2, 14, 12}; // GIOP19, GIOP18, GIOP5, GIOP17 connect to the row pins
...
//    int val2 = analogRead(35);
  ...
  if (val>800){ // && val2>800){ //Sensitivity
    delay(2000);
    serv.write(180);
    islock = 1;
    unlock = 0;
