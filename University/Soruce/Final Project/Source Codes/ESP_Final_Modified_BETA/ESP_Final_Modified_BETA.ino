...
const char* base64Encoding = "cHV0dDo3ODU=";
...
byte rowPins[ROWS] = {16, 4, 2, 15};   // GIOP16, GIOP4, GIOP0, GIOP2 connect to the column pins
...
void setup(){
  ...
  pinMode(otp23,OUTPUT); //Buzzer Pin (unused)
  pinMode(21,INPUT); //Button Pin sensor pin
  lcd.setCursor(0,0);
